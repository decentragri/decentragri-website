...
const VisionSection = () => {
  ...
  const firstText = "At Decentragri, we believe that innovation and nature are not opposing forces, but partners. Our commitment is to develop technologies that not only simplify and enhance everyday agricultural work"
          ...
          <div className="col-12">
            <div className="vision-content">
              ...
              <div className="vision-text-block">
                ...
                >
                  At Decentragri, we believe that innovation and nature are not opposing forces, but partners. Our commitment is to develop technologies that not only simplify and enhance everyday agricultural work but also actively contribute to preserving our environment. We envision a future where humanity's ingenuity and the Earth's resilience coexist in harmony, enriching lives today and securing a better tomorrow for generations to come.
                </span>
              </div>
            </div>
          </div>
